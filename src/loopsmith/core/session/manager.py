...
from loopsmith.core.bus.envelope import HandlerError
from loopsmith.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from loopsmith.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from loopsmith.core.bus.commands import SessionCompactResult
