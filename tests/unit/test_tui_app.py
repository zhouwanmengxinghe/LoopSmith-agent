...
from loopsmith.tui.app import LoopSmithTuiApp, LLMStreamBlock, ToolCallBlock, _preview
...
def test_llm_tokens_accumulate_in_block() -> None:
    app = LoopSmithTuiApp("127.0.0.1", 9999)
...
# 设计：插入 step.started 中断流，验证之后的 llm.token 创建新 LLMStreamBlock
